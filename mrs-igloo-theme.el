...
;;; mrs-igloo-theme.el --- Emacs 24 theme with a dark background.

;; Copyright (C) 2014 , Seth

;; Author: Seth
;; http://github.com/sethmcl/mrs-igloo
;; Version: 0.1
...
;;; Code:
 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'mrs-igloo
	...
	`(hl-line ((,class (:foreground ,fg1 :background  ,bg5))))
...
(provide-theme 'mrs-igloo)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; mrs-igloo-theme.el ends here
